...
class ScreenshotService():
    def __init__(self):
        ...
        # Service Server
        self.shot_service = rospy.Service("/screenshot", Trigger, self.trigger_shot)

        # Service Client
        if(self.report_to_web == True):
            rospy.wait_for_service("/file_location/screenshot")
            self.sos_service = rospy.ServiceProxy("/file_location/screenshot", Trigger)
...
if __name__=="__main__":
    rospy.init_node("screenshot_service")
    ScreenshotService()
    rospy.spin()
