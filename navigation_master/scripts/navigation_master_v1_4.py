    ...
    def route_done_checker(self, route_list, route_seq):
        ...
        if(route_list[route_seq] in self.path_dict and self.route_once):
            ...
            if(self.fsm_state=="DELIVERY"):
                ...
                if(self.fsm_state!="SUSPEND" and self.fsm_state!="MANUAL"):
...
#                self.fsm_call("DELIVERY")
    ...
    def charging_done_checker(self):
        ...
        if(self.battery_safe==False and (self.delivery_status=="COMPLETED" or self.delivery_status=="")):
            # Change FSM State into DELIVERY
            if(self.fsm_state!="DELIVERY" and self.fsm_state!="SUSPEND" and self.fsm_state!="MANUAL"):
                self.fsm_call("DELIVERY")
                self.delivery_status = "CHARGING"
...
if __name__=="__main__":
    rospy.init_node("navigation_master_v1_4")
    NavigationMasterV1_4()
    rospy.spin()
