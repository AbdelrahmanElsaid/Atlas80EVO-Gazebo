...
from atlas80evo_msgs.srv import SetLifter, SetLeaveTable, SetONOFF
from std_srvs.srv import Empty


class ActionDropoffTableV2_3():
    def __init__(self):
        ...
        # Service Servers
        self.drop_table_srv = rospy.Service("/drop_table/call", SetONOFF, self.drop_tableSRV)
    ...
    def drop_tableSRV(self, req):
        if req.onoff:
            ...
            print "table dropoff service initiated"
        else:
            self.init_table_dropoff = False
...
if __name__=="__main__":
    rospy.init_node("action_dropoff_table_v2_3")
    ActionDropoffTableV2_3()
    rospy.spin()
