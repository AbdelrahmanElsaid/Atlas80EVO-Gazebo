...
New Feature: (1) Added to rotate_HOME.path
...
#mis_activity <-> mission_activity = "NO ACTION" "MOVE" "PICK" "DROP" "CHARGE"
#mis_status <-> delivery_status = "" "ARRIVED" "DEPARTED" "CHARGING" "CANCELLED" "COMPLETED"
#location = "HOME" "A" "B" "1" "2" "3" "4" "5"

class NavigationMasterV1_7():
    def __init__(self):
...
if __name__=="__main__":
    rospy.init_node("navigation_master_v1_7")
    NavigationMasterV1_7()
    rospy.spin()
