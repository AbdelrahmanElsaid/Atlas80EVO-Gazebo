...
#                self.route_list, self.action_list, self.waypoint_list, self.charging_flag = self.getMissionDecoded(msg.data)
                self.route_list, self.action_list, self.waypoint_list, self.charging_flag = self.getMissionDecoded(self.saved_mission)
