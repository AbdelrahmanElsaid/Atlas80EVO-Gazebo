...
#        if(msg.state!="SUSPEND" and msg.state!="ERROR" and msg.state!="MANUAL"):
        if(msg.state!="SUSPEND" and msg.state!="ERROR"):
#        if(msg.state!="SUSPEND" and msg.state!="ERROR" and msg.state!="ESTOP"):
            self.pre_state=msg.state


    def suspendSRV(self, req):
        self.sleep.sleep()
#        if self.current_state!="SUSPEND":
        if(self.current_state!="SUSPEND" and self.current_state!="ESTOP"):
...
if __name__=="__main__":
    rospy.init_node("suspend_resume_handler_v4")
    SuspendResumeHandlerV4()
    rospy.spin()
