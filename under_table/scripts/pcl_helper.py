...
def pcl_to_ros(pcl_array, frame):
    ...
    for data in pcl_array:
        s = struct.pack('>f', data[2]) # Modified from data[3] into data[2]
...
def XYZI_to_XYZ(XYZI_cloud):
    """ Converts a PCL XYZI point cloud to an XYZ point cloud (removes color info)
    
        Args:
            XYZI_cloud (PointCloud_PointXYZI): A PCL XYZI point cloud
