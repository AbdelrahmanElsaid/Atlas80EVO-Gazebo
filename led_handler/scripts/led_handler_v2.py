...
class LedHandlerV2():
    def __init__(self):
        ...
        self.states = {'SUSPEND':'blue', 'CHARGING':'yellow', 'DELIVERY':'green', 'TABLE_PICKING':'green', 'MANUAL':'yellow', 'STANDBY':'blue', 'TABLE_DROPPING':'green', 'ERROR':'red', 'NONE':'off', 'TRANSITION': 'yellow', 'ESTOP': 'red'}
...
if __name__=="__main__":
    rospy.init_node("led_handler_v2")
    LedHandlerV2()
    rospy.spin()
