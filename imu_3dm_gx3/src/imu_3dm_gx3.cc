...
//-----------------------------------------------------------------------------
      ...
      msg.orientation.w = (double)q.x();// q(0);
      msg.orientation.x = (double)q.z();// q(1);
      msg.orientation.y = (double)q.w();// q(2);
      msg.orientation.z = (double)q.y();// q(3);
...
//      msg_mag.header.stamp = ros::Time::now();
//-----------------------------------------------------
