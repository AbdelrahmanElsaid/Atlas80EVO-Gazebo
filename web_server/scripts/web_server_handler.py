...
class WebServerHandler():
    ...
    def __init__(self):
        ...
        #topic suscriber
        self.web_sub = rospy.Subscriber(rospy.get_param("ros_to_web", "/web/all_status"), String, self.Callback_from_all_status, queue_size=1)
        self.all_sub = rospy.Subscriber(rospy.get_param("health_error", "/health/error"), String, self.Callback_from_health_monitoring, queue_size=1)
    ...
    def publish_to_ros(self,pub_string):
        self.pub = rospy.Publisher("/web/mission", String, queue_size=1)
    ...
    def main_loop(self):
        ...
        if (LDT.status_code == 200):
            ...
            if (Last_Delivery_details['deli_id']!=self.to_web_Delivery_ID):
                ...
                self.to_web_Delivery_Action = Last_Delivery_details['mis_activity']
            ...
            if self.to_web_Battery!="":
                try:
                    ...
                    print("error")
                if self.to_web_Delivery_Location != Last_Delivery_details['location']:
                    ...
                    .format(self.to_web_Delivery_ID, self.to_web_Delivery_Location,  self.to_web_Agv_ID, self.to_web_Delivery_Status, self.to_web_Delivery_Route, self.to_web_Delivery_Action))
                    print("updated deli_dtls")
                self.to_web_Battery=""
            else:
